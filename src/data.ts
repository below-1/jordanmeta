export const portfolios = [
  {
    ...
    description: [
      ...
      'Dibangun menggunakan Framework Svelte dan Database CockroachDB'
    ],
    pictures: [
      '/port/absensi-1.png',
      '/port/absensi-2.png'
  ...
  },
  {
    ...
    description: [
      ...
      'Dengan adanya sistem ini pengolahan data penerima bantuan lebih dimudahkan'
    ],
    pictures: [
      '/port/silo-1.png',
      '/port/silo-2.png',
  ...
  },
  {
    ...
    description: [
      ...
      'Builtin Screen Reader. Berbagai Fitur Aksesibilitas',
      'CMS Internal untuk berita dan pengumuman',
      'Terintegrasi dengan jadwal sidang dan database kasus'
    ],
    pictures: [
      '/port/pn-1.png',
      '/port/pn-2.png',
  ...
  },
  {
    ...
    description: [
      ...
      'Layanan penetuan lokasi photo shoot untuk user',
      'Layout dan Tema menggunakan TailwindCSS'
    ],
    pictures: [
      '/port/de-1.png',
      '/port/de-2.png',
  ...
  },
  {
    ...
    description: [
      ...
      'Penentuan Lokasi Obyek Wisata berdasarkan preferensi user'
    ],
    pictures: [
      '/port/wi-1.png',
      '/port/wi-2.png',
